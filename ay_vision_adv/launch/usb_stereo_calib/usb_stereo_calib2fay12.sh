...
ids=""
rosrun ay_vision_adv bin/cv_usb_node config/usbcam2fay12_calib1.yaml __name:=cv_usb_node1 &
ids="$ids $!"
rosrun ay_vision_adv bin/cv_usb_node config/usbcam2fay12_calib2.yaml __name:=cv_usb_node2 &
ids="$ids $!"
sleep 1
